    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit(onSubmit)} style={{ textAlign: 'left' }}>
          <div style={{ marginBottom: '20px' }}>
            ...
            <input
              ...
              onMouseEnter={(e) => e.target.style.borderColor = '#040405'}
              onMouseLeave={(e) => e.target.style.borderColor = '#1e1f22'}
            />
          </div>
          ...
          <button
            ...
            onMouseDown={(e) => e.target.style.backgroundColor = '#3c45a5'}
            onMouseUp={(e) => e.target.style.backgroundColor = '#4752c4'}
          >
            Log In
          </button>
        </form>
        ...
        <div style={{
          ...
          Need an account? <a href="#" style={{
            color: '#5865f2',
            textDecoration: 'none',
            fontWeight: 500
          }} onMouseEnter={(e) => e.target.style.textDecoration = 'underline'} onMouseLeave={(e) => e.target.style.textDecoration = 'none'}>Register</a>
        </div>
      </div>
    </div>
  );
